...
WSO2 is an Identity Server open source and is released under Apache Software License Version 2.0, this document covers configuing WSO2 to be used as an identity provider for Minio server STS API.
